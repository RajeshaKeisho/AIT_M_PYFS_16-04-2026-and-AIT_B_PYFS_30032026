...
class JobApplicationForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'email':forms.EmailInput(attrs={'class':'form-control', 'placeholder':"Enter Yur Email"}),
            'phone':forms.TextInput(attrs={'class':'form-control', 'placeholder':"Enter Phone Number"}),
            'cover_letter':forms.Textarea(attrs={'class':'form-control', 'placeholder':"Write a cover letter..."}),
