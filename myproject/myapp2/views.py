...
def greeting(request):
    ...
    formatted_time = current_time.strftime("%d-%m_%Y %H:%M:%S")
    return HttpResponse(f"{greeting_message}! Today, the date and timeis {formatted_time}!")
...
def message(request):
    ...
    if 6 <= hour < 12:
        ...
        greeting_msg = "Hello Student, Good Afternoon!"
    elif 16 <= hour < 21:
